...
function openWhatsApp() {
  ...
  var whatsappURL =
    "https://api.whatsapp.com/send?phone=+5581987989640&text=Oi! Gostaria de agendar um horário";
...
function sendOrder() {
  ...
  const whatsappLink = `https://api.whatsapp.com/send?phone=+5581987989640&text=${encodeURIComponent(
    message
  )}`;
